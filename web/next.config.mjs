    ...
    return [
      {
        ...
        headers: [
          ...
          {
            // Allows Next.js inline scripts, Google Fonts, Firebase CDN, Supabase connections.
            // 'unsafe-inline' required for Next.js hydration scripts; 'unsafe-eval' for dev HMR only.
